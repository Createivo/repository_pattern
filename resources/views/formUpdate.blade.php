    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mt-5">
                <form action="{{route('user.edit' ,$users->id )}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="form-group">
                        <label for="exampleInputEmail1">username</label>
                        <input type="text" name="username" value="{{$users->name}}" class="form-control" id="exampleInputEmail1">
                    </div>
                    <div class="form-group">
